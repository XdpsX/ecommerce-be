...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    protected ResponseEntity<Object> handleMethodArgumentNotValid(
        ...
        for (FieldError fieldError : ex.getBindingResult().getFieldErrors()) {
            violations.add(
                    new FieldViolation(fieldError.getField(), fieldError.getCode(), fieldError.getDefaultMessage()));
        }
    ...
    protected ResponseEntity<Object> handleExceptionInternal(
        ...
        // Always replace the body with a controlled problem so raw framework exception messages are never
        // exposed, while preserving the framework-defined client-error status.
